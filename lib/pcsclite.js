...
try{
	if(os.arch() === 'x32'){
		console.log("loading pcsclite.node for x32 architecture");
		pcsclite = require('../build/Release/x32/pcsclite.node');
	}
	else if(os.arch() === 'ia32'){
		console.log("loading pcsclite.node for ia32 architecture");
		pcsclite = require('../build/Release/ia32/pcsclite.node');
	}
	else if(os.arch() == 'x64'){
		console.log("loading pcsclite.node for x64 architecture");
		pcsclite = require('../build/Release/x64/pcsclite.node');
	}
	else{
		console.log("loading pcsclite.node for unknown architecture");
		pcsclite = require('../build/Release/pcsclite.node');
	}
}
catch(e){
	console.error("Error loading pcsclite.node", e);
}
